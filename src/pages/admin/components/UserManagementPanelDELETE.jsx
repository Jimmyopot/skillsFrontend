...
export default function UserManagementPanel() {
  ...
  const filteredUsers = mockUsers.filter((user) => {
    ...
    const matchesSkill =
      !filterSkill || user.skillsOffered.some((s) => s.toLowerCase().includes(filterSkill.toLowerCase()))
    const matchesCounty = !filterCounty || user.county.toLowerCase().includes(filterCounty.toLowerCase())
